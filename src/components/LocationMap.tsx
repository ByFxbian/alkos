  ...
  return (
    <div className="w-full h-[400px] relative rounded-xl overflow-hidden border border-neutral-800 shadow-2xl">
      ...
      <iframe
        ...
        marginHeight={0}
        marginWidth={0}
        title="ALKOS Barber Location"
        src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Wiedner%20G%C3%BCrtel%2012,%201040%20Wien+(ALKOS%20Barber)&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
